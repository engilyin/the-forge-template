...
metadata:
  reference: .github/skills/stacks/java-spring-webflux/review-checklist.md
---
...
Full reference: `.github/skills/stacks/java-spring-webflux/review-checklist.md`

Read the full skill file before applying:
```
Read @.github/skills/stacks/java-spring-webflux/review-checklist.md and run through every checklist item against the current changes.
